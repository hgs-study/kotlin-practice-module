...
class BookServiceTest @Autowired constructor(
    ...
    fun loanBookTest(){
        ...
        val savedUser = userRepository.save(User("pir", null))
        val request = BookLoanRequest("pir", "이상한 나라의 엘리스")
    ...
    fun returnBookTest(){
        ...
        val savedUser = userRepository.save(User("pir", null))
        userLoanHistoryRepository.save(UserLoanHistory.fixture(savedUser, "이상한 나라의 엘리스"))
        val request = BookReturnRequest("pir", "이상한 나라의 엘리스")
    ...
    fun countLoanedBookTest(){
        //given
        val savedUser = userRepository.save(User("현건수",null))
    ...
    @Test
    @DisplayName("분아별 책 대여 권수를 정상 확인한다")
